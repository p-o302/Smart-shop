...
<div class="single">
	<div class="container" style="display: flex;">
		...
		<div class="col-md-6 single-right-left simpleCart_shelfItem animated wow slideInRight animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: slideInRight;">
			...
			<p><span class="item_price">$ <?php echo number_format($record->price - ($record->price * $record->discount / 100)); ?></span> <del> $<?php echo number_format($record->price); ?></del></p>
			<div class="rating1">
			...
			<div class="occasion-cart" style="margin-top: 15px;"> 
				<a href="index.php?controller=cart&action=create&id=<?php echo $record->id; ?>" class="item_add hvr-outline-out button2">Add to cart</a>
			</div>
					...
					<div class="bootstrap-tab-text-grids">
						<div class="bootstrap-tab-text-grid">
							<div class="bootstrap-tab-text-grid-left">
								<img src="assets/upload/products/<?php echo $record->photo; ?>" alt=" " class="img-responsive">
							</div>
